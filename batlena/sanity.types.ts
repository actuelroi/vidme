...
// Query: *[_type == "product"] | order(name asc) {      ...,      vendor->{        _id,          _type,        name,        image      }    }
...
// Query: *[_type == "product" && slug.current == $slug] | order(name asc) [0]    {      ...,      vendor->{  _id,  _type,  _createdAt,  _updatedAt,  _rev,  name,  image,  rating}    }
