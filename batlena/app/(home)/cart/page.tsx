...
const page = () => {
    ...
    const { deleteCartProduct, getTotalPrice, getItemCount, resetCart, getGroupedItems } = useCartStore();
                    ...
                    <div className="grid lg:grid-cols-3 md:gap-8">
                        <div className="lg:col-span-2 rounded-lg">
                            <div className="border bg-white rounded-md">
                                {groupedItems?.map(({ product, selectedSize, selectedColor, selectedShoesSize, quantity }) =>
                                    <div
                                        key={product?._id}
